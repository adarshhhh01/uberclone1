...
import { getUserToken } from '../utils/authTokens.js'
   ...
   useEffect(() => {
    ...
    return (
        <div className='h-screen relative overflow-hidden'>
            <img className='w-16 absolute left-5 top-5 z-5 ' src="https://upload.wikimedia.org/wikipedia/commons/c/cc/Uber_logo_2018.png" alt="" />
            ...
            <div className=' flex flex-col justify-end h-screen absolute top-0 w-full'>
                <div className='h-[30%] p-6 bg-white relative'>
                    <h5 ref={panelCloseRef} onClick={() => {
                        setPanelOpen(false)
                    }} className='absolute opacity-0 right-5 top-[-10%] bg-gray-500 rounded-full pt-10 text-2xl z-20'>
                ...
                <div ref={panelRef} className='bg-white h-0 z-0' >
                    <LocationSearchPanel
